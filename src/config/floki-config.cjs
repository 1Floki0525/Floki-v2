...
function getSelfImprovementConfig(mode = 'chat') {
  ...
  return Object.freeze({
    ...
    rsi_terminal_chunk_bytes: numberValue('rsi_terminal_chunk_bytes'),
    rsi_terminal_window_bytes: numberValue('rsi_terminal_window_bytes'),
    rsi_terminal_bootstrap_poll_ms: numberValue('rsi_terminal_bootstrap_poll_ms'),
